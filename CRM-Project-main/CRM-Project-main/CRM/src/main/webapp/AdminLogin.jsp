...
body{
  background:rgba(219, 236, 235, 0.829);
  overflow: hidden;
}
::selection{
...
.wrapper{
  ...
  border-radius: 5px;
  box-shadow: 0px 4px 10px 1px rgba(20, 49, 28, 0.1);
}
.wrapper .title{
  height: 90px;
...
.wrapper form .button input{
  ...
  font-weight: 500;
  padding-left: 0px;
  background:  rgba(6, 57, 31, 0.669);
  border: 1px solid #050707;
  cursor: pointer;
}
form .button input:hover{
  background:  rgba(3, 129, 64, 0.669);
}
...
form .signup-link a:hover{
  ...
  <div class="main">
    <div class="container">
      <div class="wrapper">
        <div class="title"><span><b>Admin Login</b></span></div>
        ...
        <!-- <div class="pass"><a href="#">Forgot password?</a></div> -->
         <div class="row button">
          ...
          <div class="signup-link">Not a member? <a href="AdminRagistrationjsp.jsp">Signup now</a></div>
        </form>
       	</div>
