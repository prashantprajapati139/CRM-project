...
/**
 * Servlet implementation class AdminRagistration
 */
@WebServlet("/AdminRagistration")
public class AdminRagistration extends HttpServlet {
...
//		HttpSession  s= req.getSession();
		   ...
		   RequestDispatcher rd=req.getRequestDispatcher("/AdminRagistration.jsp");
			rd.include(req, res);
	}
	/*
